...
\emph{Author:}\\
{Aditya Nisal} % Author name - remove the \href bracket to remove the link
...
\vspace{2cm}
\large \textit{A thesis submitted in partial fulfilment of the requirements\\ for DEGREE NAME}\\[0.3cm] % University requirement text
\textit{at}\\[0.4cm]
Software Engineering Chair \\Saarland University\\[2cm] % Research group name and department name
