...
\subfigure[AUT version $V_{0}$]{\label{fig:3a}\includegraphics[width=5.6cm,height=2.8cm]{./Figures/newlogin}}
\vspace{-2mm}\subfigure[AUT version $V_{1}$]{\label{fig:3b}\includegraphics[width=5.6cm,height=2.8cm]{./Figures/newsignin}}
...
In this manner, the design strategy of a test-suite can also impact its maintenance effort. The \textit{effort} of maintaining a test-suite can be measured in terms of the number of GUI locators changed, added, and removed during two subsequent revisions $V_{0}$ and $V_{1}$ of the AUT. If developers know which type of locators are robust and do not need to be frequently repaired, they write more robust tests by improving the test design.
